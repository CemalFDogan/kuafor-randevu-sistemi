                ...
                <Col md={6} className="register-section">
                    ...
                    <Form>
                        <Form.Group controlId="formBasicFullName">
                            ...
                            <Form.Control type="text" placeholder="Tam adınızı girin" />
                        </Form.Group>
                        ...
                        <Form.Group controlId="formBasicPassword">
                            <Form.Label>Şifre</Form.Label>
                            <Form.Control type="password" placeholder="Bir şifre belirleyin" />
                        </Form.Group>

                        <Form.Group controlId="formBasicPhoneNumber">
                            <Form.Label>Telefon Numarası</Form.Label>
                            <Form.Control type="tel" placeholder="Telefon numaranızı girin" />
                        </Form.Group>
